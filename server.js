      ...
      var fixtureModalHeader = [
        '<div class="row">',
          '<div class="col-lg-12 mx-auto">',
            ...
            '<a class="card-footer text-center btn bg-color1" data-dismiss="modal" aria-label="Close" id="butn' + record.fields.artistrecordid +'" onclick="ga("send", "event", "card", "select","'+ record.fields.id +'");">SELECT</a>',
